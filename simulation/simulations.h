...
template <class T>
requires IsMockOracle<T>
vector<double> run_n_expo_cond_bucket_sims(double min_freq, size_t k, size_t k_hh, double oracle_ep, size_t deg, size_t nsims, Dataset& ds){
    auto t1 = chrono::high_resolution_clock::now();
    ...
    for(int i = 0; i < nsims; i++) {
        ...
        estimates[i] = cond_bucket_sketch(k_hh, deg, b, o, ds);
...
template <class T>
requires IsMockOracle<T>
vector<double> run_n_linear_cond_bucket_sims(size_t k, size_t k_hh, double oracle_ep, size_t deg, size_t nsims, Dataset& ds){
    auto t1 = chrono::high_resolution_clock::now();
...
template <class T>
requires IsMockOracle<T>
vector<double> run_n_expo_alt_bucket_sims(double min_freq, size_t k, size_t k_hh, double oracle_ep, size_t deg, size_t nsims, Dataset& ds){
    auto t1 = chrono::high_resolution_clock::now();
    ...
    for(int i = 0; i < nsims; i++) {
        ...
        estimates[i] = alt_bucket_sketch(k_hh, deg, b, o, ds);
...
template <class T>
requires IsMockOracle<T>
vector<double> run_n_linear_alt_bucket_sims(size_t k, size_t k_hh, double oracle_ep, size_t deg, size_t nsims, Dataset& ds){
    auto t1 = chrono::high_resolution_clock::now();
